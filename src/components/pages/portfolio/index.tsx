...
const DetailPortfolio = React.lazy(() => import('./detail/DetailPortfolio'));
const Pagination = React.lazy(() => import('../../common/Pagination'));
const Searching = React.lazy(() => import('../../common/Searching'));
...
function Portfolio({ bright }: PortfolioProps) {
  ...
  useEffect(() => {
    document.title = 'Hi, Fahmi | Portfolio';
  }, []);
    ...
    <Fragment>
      ...
      <div className="pt-28 pb-4 w-full  xl:min-h-[calc(100vh-3rem)] px-2 md:px-0">
        ...
        {currentTableData.length ? (
          ...
          <div className=" min-h-[calc(57vh-49px)] xl:min-h-[calc(53vh-3rem)] flex items-center justify-center text-center">
