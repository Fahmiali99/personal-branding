      ...
      >
        <button
          className={classnames(
            "inline-flex h-8 w-8 items-center justify-center rounded-full border border-gray-200",
            {
        ...
        {paginationRange.map((pageNumber: any, idx: string) => {
          ...
          return (
            <button
              key={idx}
              className={classnames(
                "block h-8 w-8 rounded-full text-center leading-8 border border-gray-200",
                {
